...
import { PET_OPTION_TYPE_WORDS, reorderPatches } from "../petOptions";
 ...
 * option may also be inactive, and "Nonaktif" about a row that is gone from
 * every picker answers the less important half of the question.
 */
function PetOptionStatus({ option }: { option: PetOption }) {
